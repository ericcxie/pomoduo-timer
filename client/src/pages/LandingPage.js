    ...
    <main>
      ...
      >
        ...
        <div className="space-y-2 mt-8">
          <h1 className="text-5xl font-bold text-gray-600 text-center cursor-default">
            Pomo<span className="text-green-400">Duo</span> Timer
          </h1>
          <p className="text-lg text-center text-gray-600 italic font-semibold cursor-default">
            Stay <span className="text-green-400">productive</span> together!
          </p>
        </div>

        <a
          className="group relative inline-block text-sm font-medium text-green-400 focus:outline-none focus:ring active:text-green-400 mb-4 mt-6"
          href="/generate"
        >
